...
public class NoticiaController {
    ...
    public void loadNews(ActionEvent aEv){
        ...
        if(count < 1 || count > ejbFacadeC.count() + 1){
            ...
            carrusel.setIdcarrusel(selectNoticia.getId());
            carrusel.setBrvideo(brVideo);
            carrusel.setBraudio(brAudio);
            carrusel.setNombrevideo(tituloVideo);
            carrusel.setNombreaudio(tituloAudio);
            ...
            carrusel2.setIdcarrusel(selectNoticia.getId());
            carrusel2.setBrvideo(brVideo);
            carrusel2.setBraudio(brAudio);
            carrusel2.setNombrevideo(tituloVideo);
            carrusel2.setNombreaudio(tituloAudio);
