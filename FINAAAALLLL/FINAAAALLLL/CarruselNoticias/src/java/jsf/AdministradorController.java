...
public class AdministradorController {
    ...
    @EJB private ejb.AdministradorFacade ejbFacade;
    ...
    public static class AdministradorControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Administrador) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: "+AdministradorController.class.getName());
            }
        }
