...
public abstract class AbstractFacade<T> {
    ...
    public Integer obtenerPerfil(String user, String password) {
        System.out.println("en ObtenerPerfil " + user +":"+ password );
//        StringBuilder sql = new StringBuilder();
        /*sql.append("SELECT a.idadministrador FROM Administrador a ");
        sql.append("WHERE a.usuario = '");
        sql.append(user);
        sql.append("'");
        sql.append(" AND a.claveadministrador = '");
        sql.append(password);
        sql.append("'");*/
        EntityManager em = getEntityManager();
//        Query query = em.createNativeQuery(sql.toString());
        Query query = em.createNamedQuery("Administrador.findByLoginAdministrador");
        query.setParameter("usuario",user);
        query.setParameter("claveadministrador", password);
