...
@ManagedBean (name="codigoController")
@SessionScoped
public class CodigoController {

    private Codigo current;
    private DataModel items = null;
    @EJB private ejb.CodigoFacade ejbFacade;
    ...
    public static class CodigoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Codigo) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: "+CodigoController.class.getName());
            }
        }
